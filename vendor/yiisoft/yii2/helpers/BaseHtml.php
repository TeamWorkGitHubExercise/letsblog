...
class BaseHtml
{
     ...
     * such as an images tag. If this is coming from end users, you should consider [[encode()]]
    ...
    /**
     * Generates an images tag.
     * @param array|string $src the images URL. This parameter will be processed by [[Url::to()]].
     * @param array $options the tag options in terms of name-value pairs. These will be rendered as
     * the attributes of the resulting tag. The values will be HTML-encoded using [[encode()]].
     * If a value is null, the corresponding attribute will not be rendered.
     * See [[renderTagAttributes()]] for details on how attributes are being rendered.
     ...
     * @return string the generated images tag
     */
     ...
     * such as an images tag. If this is is coming from end users, you should [[encode()]]
     * it to prevent XSS attacks.
     ...
     * Therefore you can pass in HTML code such as an images tag. If this is is coming from end users,
     ...
     *   in HTML code such as an images tag. If this is is coming from end users, you should [[encode()]] it to prevent XSS attacks.
