...
/**
 * Captcha renders a CAPTCHA images and an input field that takes user-entered verification code.
 *
 ...
 *
 * The images element rendered by Captcha will display a CAPTCHA images generated by
 * an action whose route is specified by [[captchaAction]]. This action must be an instance of [[CaptchaAction]].
 *
 * When the user clicks on the CAPTCHA images, it will cause the CAPTCHA images
...
class Captcha extends InputWidget
{
    ...
    /**
     * @var array HTML attributes to be applied to the CAPTCHA images tag.
     * @see \yii\helpers\Html::renderTagAttributes() for details on how attributes are being rendered.
     */
    public $imageOptions = [];
    /**
     * @var string the template for arranging the CAPTCHA images tag and the text input tag.
     * In this template, the token `{images}` will be replaced with the actual images tag,
     * while `{input}` will be replaced with the text input tag.
     */
    public $template = '{images} {input}';
    /**
    ...
    public function init()
    {
        ...
        if (!isset($this->imageOptions['id'])) {
            $this->imageOptions['id'] = $this->options['id'] . '-images';
        }
    }
