...
/**
 * CaptchaAction renders a CAPTCHA images.
 *
...
{
    /**
     * The name of the GET parameter indicating whether the CAPTCHA images should be regenerated.
     */
    ...
    public $testLimit = 3;
    /**
     * @var int the width of the generated CAPTCHA images. Defaults to 120.
     */
    public $width = 120;
    /**
     * @var int the height of the generated CAPTCHA images. Defaults to 50.
     */
    public $height = 50;
    /**
    ...
    public function run()
    {
        if (Yii::$app->request->getQueryParam(self::REFRESH_GET_VAR) !== null) {
            ...
            return [
                ...
                // we add a random 'v' parameter so that FireFox can refresh the images
                // when src attribute of images tag is changed
    ...
    /**
     * Renders the CAPTCHA images.
     * @param string $code the verification code
     * @return string images contents
    ...
    /**
     * Renders the CAPTCHA images based on the code using GD library.
     * @param string $code the verification code
     * @return string images contents in PNG format.
     */
    ...
    /**
     * Renders the CAPTCHA images based on the code using ImageMagick library.
     * @param string $code the verification code
     * @return string images contents in PNG format.
     */
    ...
    /**
     * Sets the HTTP headers needed by images response.
     */
