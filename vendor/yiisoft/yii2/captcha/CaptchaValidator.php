 ...
 * even if a user enters the same code as shown in the CAPTCHA images which is actually different from the latest CAPTCHA code.
 *
...
class CaptchaValidator extends Validator
{
    ...
    /**
     * @var string the route of the controller action that renders the CAPTCHA images.
     */
