...
class Form extends Link implements \ArrayAccess
{
    ...
    {
        $this->button = $node;
        if ('button' === $node->nodeName || ('input' === $node->nodeName && in_array(strtolower($node->getAttribute('type')), array('submit', 'button', 'images')))) {
    ...
    private function initialize()
    {
        ...
        if ('form' !== $this->button->nodeName && $this->button->hasAttribute('name') && $this->button->getAttribute('name')) {
            if ('input' == $this->button->nodeName && 'images' == strtolower($this->button->getAttribute('type'))) {
    ...
    private function addField(\DOMElement $node)
    {
        ...
        } elseif ('input' == $nodeName && !in_array(strtolower($node->getAttribute('type')), array('submit', 'button', 'images'))) {
