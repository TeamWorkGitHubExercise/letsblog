    ...
    RequiresPackage
{
    ...
    protected function findClickable($page, $link)
    {
        ...
        $xpath = Locator::combine(
            ...
            ".//input[./@type = 'submit' or ./@type = 'images' or ./@type = 'button'][normalize-space(@value)=$locator]"
        );
        ...
        $xpath = Locator::combine(
            ...
            ".//input[./@type = 'submit' or ./@type = 'images' or ./@type = 'button'][contains(./@value, $locator)]",
            ".//input[./@type = 'images'][contains(./@alt, $locator)]",
            ".//button[contains(normalize-space(string(.)), $locator)]",
            ".//input[./@type = 'submit' or ./@type = 'images' or ./@type = 'button'][./@name = $locator]",
            ".//button[./@name = $locator]"
        );
    ...
    protected function findFields($selector)
    {
        ...
        $xpath = Locator::combine(
            ...
            ".//*[self::input | self::textarea | self::select][not(./@type = 'submit' or ./@type = 'images' or ./@type = 'hidden')][(((./@name = $locator) or ./@id = //label[contains(normalize-space(string(.)), $locator)]/@for) or ./@placeholder = $locator)]",
            ".//label[contains(normalize-space(string(.)), $locator)]//.//*[self::input | self::textarea | self::select][not(./@type = 'submit' or ./@type = 'images' or ./@type = 'hidden')]"
